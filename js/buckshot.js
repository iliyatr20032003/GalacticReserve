...
function initBuckshotScene(){
    ...
    const wallTexture = createGrimeTexture('#4a3a34', '#2b1d1d');
    const floorTexture = createGrimeTexture('#3a2f2a', '#151010');
    const ceilingTexture = createGrimeTexture('#4f3f39', '#1e1414');
    ...
    shotgun.position.set(0.4, 0.3, -0.4);
    scene.add(shotgun);
